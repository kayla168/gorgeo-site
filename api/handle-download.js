...
const document_library = {
    ...
    'Blind_Fit': {
        filePath: 'drop/GorgeoFasteners_Checklist_BlindFit_SleeveDesign.pdf',
...
export default async function handler(req, res) {
    ...
    try {
        ...
        // ========================> 在这里添加了调试代码 <========================
        // 这个日志会告诉我们线上代码到底读取到了什么环境变量
        console.log("--- DEBUGGING MAILER ENV VARIABLES ---");
        console.log("SMTP Host from env:", process.env.SMTP_HOST);
        console.log("SMTP Port from env:", process.env.SMTP_PORT);
        console.log("SMTP User from env:", process.env.SMTP_USERNAME);
        // 为了安全，我们只检查密码是否存在，而不打印它的值
        console.log("SMTP Pass from env exists:", !!process.env.SMTP_PASSWORD);
